...
CREATE TABLE `hj_admin_user` (
  ...
  `g_id` int(10) DEFAULT NULL COMMENT '用户所在用户组',
...
-- ----------------------------
INSERT INTO `hj_admin_user` VALUES ('1', 'admin', '系统创建者', '1', '1528277232', null, null, '1', null, null, '34', '1', '0000-00-00 00:00:00', null, '', 'e10adc3949ba59abbe56e057f20f883e');
